...
public class BouncingBall extends JFrame {
	...
	// menuBar 객체 만들기
	private JLabel menuBar = new JLabel(new ImageIcon(Main.class.getResource("../images/menuBar_조금두꺼운푸른회색.png")));
	...
	private ImageIcon quitButtonHoverImage = new ImageIcon(Main.class.getResource("../images/quit_button(hover).png"));
