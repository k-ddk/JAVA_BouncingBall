...
public class BouncingBall extends JFrame {
	...
	// menuBar 객체 만들기
	private JLabel menuBar = new JLabel(new ImageIcon(Main.class.getResource("../images/menuBar_살색.png")));
	...
	private Image introBackground = new ImageIcon(Main.class.getResource("../images/introBackground_밤하늘내버전.png"))
			.getImage();
	...
	public BouncingBall() {
		...
		exitButton.setBounds(1207, -12, 64, 64);
